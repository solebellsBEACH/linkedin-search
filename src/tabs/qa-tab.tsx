...
export function QaTab() {
  ...
  const [tech, setTech] = useState("QA");
  ...
  const handleSearch = () => {
    const query = buildQuery(tech, seniority, tab, tipoVaga, CONTENT_KEYWORDS_QA, jobType, region);
  ...
  return (
    <>
      ...
      <Input label="Tecnologia:" placeholder="QA, Teste, Automation..." value={tech} onChange={setTech} />
